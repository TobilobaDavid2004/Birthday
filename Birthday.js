...
export default function BirthdaySite() {
  ...
  useEffect(() => {
    if (showMessage) {
      const audio = new Audio("https://www2.cs.uic.edu/~i101/SoundFiles/HappyBirthday.mid");
      audio.play();
    }
  }, [showMessage]);
      ...
      <div className="flex space-x-4 mb-8">
        {["🎈", "🎈", "🎈", "🎈"].map((balloon, i) => (
          <motion.div
            ...
            initial={{ y: 100 }}
            animate={{ y: -20 }}
            transition={{ repeat: Infinity, duration: 2 + i, repeatType: "reverse" }}
            className="text-4xl"
          >
            {balloon}
          </motion.div>
        ...
        <>
          ...
          >
            <p className="text-xl font-medium text-gray-700">
              ...
              May this year bring you laughter, blessings, and unforgettable memories. 🥳
            </p>
          </motion.div>
        </>
      )}
